 seqfile = codon_alignment.phy     * input PHYLIP alignment file
     treefile = tree_Sminthopsis_crassicaudata.nwk         * tree file with one branch labeled as #1
      outfile = branchmodel_Sminthopsis_crassicaudata_results.txt * output file
