...
#for spe in `cat Chiroptera.txt`
#do
#echo $spe
#python ../split_phylogeny_into_groups_fg.py --tree "$spe"_labelled.nwk --aln codon_alignment.phy --n_groups 3 --outdir splits_"$spe" --id_match_mode relaxed
#done

for species in `cat Chiroptera.txt|head -n 21|tail -n 7`
do
