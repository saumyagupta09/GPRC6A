 seqfile = codon_alignment.phy     * input PHYLIP alignment file
     treefile = tree_Piliocolobus_tephrosceles.nwk         * tree file with one branch labeled as #1
      outfile = branchmodel_Piliocolobus_tephrosceles_results.txt * output file
