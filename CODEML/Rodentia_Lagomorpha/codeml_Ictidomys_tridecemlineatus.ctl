 seqfile = codon_alignment.phy     * input PHYLIP alignment file
     treefile = tree_Ictidomys_tridecemlineatus.nwk         * tree file with one branch labeled as #1
      outfile = branchmodel_Ictidomys_tridecemlineatus_results.txt * output file
