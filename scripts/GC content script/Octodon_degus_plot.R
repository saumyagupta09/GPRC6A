#!/usr/bin/env Rscript
library(ggplot2)
input_file <- "Octodon_degus_gcpcnt.bed"
rectangles_file <- "new_Octodon_degus_absolute_lengths.txt"
...
rectangles_putative <- rectangles[grep("putative", rectangles$ID), ]
...
ggsave("Octodon_degus_gccontent_plot.pdf", plot = p, width = 10, height = 6)
