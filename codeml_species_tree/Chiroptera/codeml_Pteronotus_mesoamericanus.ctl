 seqfile = codon_alignment.phy     * input PHYLIP alignment file
     treefile = tree_Pteronotus_mesoamericanus.nwk         * tree file with one branch labeled as #1
      outfile = branchmodel_Pteronotus_mesoamericanus_results.txt * output file
