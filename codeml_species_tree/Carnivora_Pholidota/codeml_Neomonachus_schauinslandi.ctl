 seqfile = codon_alignment.phy     * input PHYLIP alignment file
     treefile = tree_Neomonachus_schauinslandi.nwk         * tree file with one branch labeled as #1
      outfile = branchmodel_Neomonachus_schauinslandi_results.txt * output file
